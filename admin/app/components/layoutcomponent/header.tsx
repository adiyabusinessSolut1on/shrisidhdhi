        ...
        <div className="grid w-full h-full grid-cols-2 mx-4 md:grid-cols-1 md:mr-6 md:mx-0 ">
          <div className="flex items-center h-full gap-2 px-2 md:hidden">
            ...
            <p className="flex items-center gap-1 text-3xl font-semibold text-gray-800 ">
              <Image
                ...
                width={800}
                height={800}
                className=" w-20 h-10 lg:max-w-30 "
                alt="Logo"
              />
            </p>
          </div>
          ...
          <div className="md:w-1/2 lg:w-[30%]  items-center justify-self-end flex gap-4 lg:gap-8 justify-end  relative">
            ...
            <div className="relative flex items-center">
              <IoMdNotifications
                className={`${
                  showNotification ? "text-[#f4cc92]" : "text-[#fbd9a5]"
                } cursor-pointer w-7 h-7 hover:text-[#f4cc92]`}
              ...
              <span className="absolute flex w-2 h-2 top-1 right-1">
                ...
                <span className="relative inline-flex w-2 h-2 rounded-full bg-[#7d5a25]"></span>
              </span>
            </div>

            <div className="flex items-center justify-start font-bold text-[#7d5a25] md:w-1/2 font-lato">
              {/* time */}
              <div className="pr-2 text-xs border-r border-[#7d5a25] md:text-sm">
                {time}
              </div>
              {/* date and month */}
            ...
            >
              {clicked && (
                <div
                  ref={ref}
                  className={`lg:absolute min-w-[15rem] z-50 top-12 p-2 bg-blue-50 border border-gray-600 rounded-[7px] -right-0 `}
                >
                  ...
                  <div
                    ...
                    className="text-red-600 font-700 border-t p-2 hover:rounded-[5px] border-gray-600 hover:bg-blue-200 cursor cursor-pointer"
                  >
                    {" "}
                    Logout
                  </div>
              ...
              <div className={`flex  items-center justify-center p-1`}>
                <FaUserCog
                  className={` cursor-pointer w-8 h-8  text-[#7d5a25] `}
                />
              </div>
            </div>
          </div>
